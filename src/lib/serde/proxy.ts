import { makeCachedProxyFactory } from '#lib/utils/cached-proxy.js';
...
export type SerdeProxy<T> =
	T extends StringWrapper<string>
		? T['value']
		: T extends NumberWrapper<boolean>
			? T['value']
			: T extends BoolWrapper
				? T['value']
				: // eslint-disable-next-line @typescript-eslint/no-explicit-any
					T extends EnumWrapper<any, boolean>
					? T['value']
					: // eslint-disable-next-line @typescript-eslint/no-explicit-any
						T extends Derive<any, infer R>
						? R
						: T extends Macro<false>
							? number
							: T extends Macro<true>
								? number | null
								: T extends ArrayWrapper<infer A>
									? SerdeProxy<A>[]
									: T extends Array<infer A>
										? SerdeProxy<A>[] & { $: Array<A> }
										: // eslint-disable-next-line @typescript-eslint/no-explicit-any
											T extends (
													this: SerdeProxy<any>,
													...args: infer Args
